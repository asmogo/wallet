...
object UiTestTags {
    ...
    const val DriveBackupScreen = "cashu.screen.drive-backup"
    const val DriveBackupToggle = "cashu.drive-backup.toggle"
    const val OnboardingDriveRestore = "cashu.onboarding.drive-restore"
    const val DriveRestoreCta = "cashu.onboarding.drive-restore.restore"
